...
public class StopNotIssuedAccountNumberChangedStatusArrivalCallbackTest {
    @Autowired
    ...
    @Test
    public void testStopNotIssuedAccountNumberChanged() throws CallbackException, WorkFlowServiceException {
        ...
        check.setCheckNumber(StopNotIssuedAccountNumberChangedStatusArrivalCallbackTest.shortUUID());
