...
public class StalePaidAccountNumberChangedStatusArrivalCallbackTest {
    @Autowired
    ...
    @Test
    public void testStalePaidAccountNumberChangedStatusArrivalCallbackChangedAccountNumberExisting() throws CallbackException, WorkFlowServiceException {
        ...
        check.setCheckNumber(StalePaidAccountNumberChangedStatusArrivalCallbackTest.shortUUID());
        ...
        //start -> issued -> stale(s) -> stalePaid(a) -> Stale, Paid(s) -> changeAccountNumber(a)
        // -> Stale Paid Check number changed (a) -> StalePaidAccountNumberChangedStatusArrivalCallback
        String series = "created,stale,stalePaid,changeAccountNumber";
