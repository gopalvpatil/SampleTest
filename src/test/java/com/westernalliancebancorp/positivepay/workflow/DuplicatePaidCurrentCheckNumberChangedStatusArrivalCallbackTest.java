...
public class DuplicatePaidCurrentCheckNumberChangedStatusArrivalCallbackTest {
    @Autowired
    ...
    public void testDuplicatePaidCurrentCheckNumberChangedStatusArrivalCallback() throws CallbackException, WorkFlowServiceException {
        ...
        check.setCheckNumber(DuplicatePaidCurrentCheckNumberChangedStatusArrivalCallbackTest.shortUUID());
        ...
        checkDto.setReferenceDataId(createReferenceData(check).getId());
        userData.put(Constants.CHECK_DTO, checkDto);
        series = "duplicatePaid,changeCurrentCheckNumber";
        for (String actionToPerform : series.split(",")) {
            if(actionToPerform.equals("changeCurrentCheckNumber")){
