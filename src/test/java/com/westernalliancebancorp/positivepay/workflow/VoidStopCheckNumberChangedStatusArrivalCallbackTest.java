...
public class VoidStopCheckNumberChangedStatusArrivalCallbackTest {
    @Autowired
    ...
    @Test
    public void testVoidStopCheckNumberChangesStatusArrivalCallbackThroughVoidStatusArrivalCallback() throws CallbackException, WorkFlowServiceException {
        ...
        check.setCheckNumber(VoidStopCheckNumberChangedStatusArrivalCallbackTest.shortUUID());
        ...
        //Void(a) -> Void (s) -> VoidStatusArrivalCallback -> voidStop(a) -> Void, Stop -> changeCheckNumber(a)
        // -> Void Stop, Check number changed (a) -> VoidStopCheckNumberChangedStatusArrivalCallback
    ...
    @Test
    public void testVoidStopCheckNumberChangesStatusArrivalCallbackThroughVoidStatusArrivalChangedCheckNumberExistingCallback() throws CallbackException, WorkFlowServiceException {
        Account account = accountDao.findById(1l);
        ItemType itemType = itemTypeDao.findByCode(ItemType.CODE.I.name());
        CheckStatus checkStatus = checkStatusDao.findByNameAndVersion("start", 1);
        Check check = new Check();
    ...
    @Test
    public void testVoidStopCheckNumberChangedStatusArrivalCallback() throws CallbackException, WorkFlowServiceException {
        Account account = accountDao.findById(1l);
        ItemType itemType = itemTypeDao.findByCode(ItemType.CODE.I.name());
        CheckStatus checkStatus = checkStatusDao.findByNameAndVersion("start", 1);
        Check check = new Check();
        ...
        //Void(a) -> Void (s) -> voidStop(a) -> Void, Stop -> changeCheckNumber(a)
        // -> Void Stop, Check number changed (a) -> VoidStopCheckNumberChangedStatusArrivalCallback
        String series = "void,voidStop,changeCheckNumber";
        for (String actionToPerform : series.split(",")) {
            String result = workflowService.performAction(check.getId(), actionToPerform, userData);
            System.out.println("Result is " + result);
        }
    ...
    @Test
    public void testVoidStopCheckNumberChangedStatusArrivalCallbackChangedCheckNumberExisting() throws CallbackException, WorkFlowServiceException {
        Account account = accountDao.findById(1l);
        ItemType itemType = itemTypeDao.findByCode(ItemType.CODE.I.name());
        CheckStatus checkStatus = checkStatusDao.findByNameAndVersion("start", 1);
        Check check = new Check();
