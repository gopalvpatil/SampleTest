...
public class PaidNotIssuedCheckNumberChangedStatusArrivalCallbackTest {
    @Autowired
    ...
    @Test
    public void testPaidNotIssued() throws CallbackException, WorkFlowServiceException {
        ...
        check.setCheckNumber(PaidNotIssuedCheckNumberChangedStatusArrivalCallbackTest.shortUUID());
