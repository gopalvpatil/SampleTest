...
public class CheckHistoryJpaDaoTest {
    @Loggable
    ...
    @Test
    public void testFindOrderedCheckHistory() throws Exception {
        List<CheckHistory> checkHistoryList = checkHistoryDao.findOrderedCheckHistory(113263l);
        logger.info("-------------Start----------------------");
        int i = 0;
