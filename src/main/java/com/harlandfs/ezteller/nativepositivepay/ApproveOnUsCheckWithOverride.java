 ...
 *         &lt;element name="nSupervisorID" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="nSupervisorBranchID" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ApproveOnUsCheckWithOverride")
public class ApproveOnUsCheckWithOverride {
    ...
    protected int nSupervisorID;
    protected int nSupervisorBranchID;
    ...
    /**
     * Gets the value of the nSupervisorID property.
     * 
     */
    public int getNSupervisorID() {
        return nSupervisorID;
    }

    /**
     * Sets the value of the nSupervisorID property.
     * 
     */
    public void setNSupervisorID(int value) {
        this.nSupervisorID = value;
    }

    /**
     * Gets the value of the nSupervisorBranchID property.
     * 
     */
    public int getNSupervisorBranchID() {
        return nSupervisorBranchID;
    }

    /**
     * Sets the value of the nSupervisorBranchID property.
     * 
     */
    public void setNSupervisorBranchID(int value) {
        this.nSupervisorBranchID = value;
    }
