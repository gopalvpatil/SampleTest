 ...
 * Time:	6:49:15 PM
 */
public class MHtmlReportProcessor extends AbstractReportProcessor {
	@Override
	public void exportReport(JasperPrint jp, ByteArrayOutputStream baos) {		
		try {
			...
			throw new RuntimeException("Error occurred exporting MHTML report ", e);
		}
	}
	...
	public void writeReport(HttpServletResponse response,
		...
		super.writeResponse(response, baos, templateName, Constants.MEDIA_TYPE_MHTML, Constants.FILE_EXTENSION_MHTML);	
	}
}
