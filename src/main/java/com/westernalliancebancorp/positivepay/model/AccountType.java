...
@Entity
public class AccountType implements Serializable, Auditable {
	
	private static final long serialVersionUID = -2020702448496153333L;
    ...
    @OneToMany(mappedBy = "accountType", fetch = FetchType.LAZY, targetEntity = Account.class)
