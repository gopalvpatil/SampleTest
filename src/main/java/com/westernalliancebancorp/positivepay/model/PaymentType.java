...
@Entity
public class PaymentType implements Serializable, Auditable {

	private static final long serialVersionUID = 6697866107582401202L;
    ...
    @OneToMany(mappedBy = "paymentType", fetch = FetchType.LAZY, targetEntity = Account.class)
