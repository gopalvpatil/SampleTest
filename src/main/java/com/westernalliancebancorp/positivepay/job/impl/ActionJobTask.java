...
/**
 * This class is for job types which does not have job action type configured
 * @author Gopal Patil
 *
 */
@Component("actionJobTask")
public class ActionJobTask extends AbstractProcessTask {
