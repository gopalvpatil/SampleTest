...
public class BottomLineAuthenticationToken  extends AbstractAuthenticationToken implements Serializable {
     ...
     * @param authorities
     */
    public BottomLineAuthenticationToken(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) {
        super(authorities);
     ...
     * <code>BottomLineAuthenticationToken</code>, as the {@link
     * #isAuthenticated()} will return <code>false</code>.
     *
     */
    public BottomLineAuthenticationToken(Object principal, Object credentials) {
        super(null);
        this.principal = principal;
        this.credentials=credentials;
